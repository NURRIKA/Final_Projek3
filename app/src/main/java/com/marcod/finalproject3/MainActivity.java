package com.marcod.finalproject3;
...
public class MainActivity extends AppCompatActivity {
    ...
    Button btnDel, btnAns, btn1, btn3, btn2, btn4, btn5, btn6, btn7, btn8, btn9, btn0, btnBagi, btnKurang, btnKali, btnTambah, btnPersen, btnKoma;
    TextView tvInput;
    String process;
